...
/**
 * The bullet of the game. It moves and bounces off the walls and the paddle.
 * 
 * @author 
 * @version 1.0
 */
public class Bullet extends Actor
{
    ...
    /**
     * Move the bullet. Then check what we've hit.
     */
    public void move()
    {
    ...
    /**
     * Move the bullet a given distance sideways.
     */
    ...
    /**
     * Release the bullet from the paddle.
     */
    public void release()
    {
    ...
    public void action()
    {
        ...
        if (actor !=null && !(actor instanceof Message))
        {
